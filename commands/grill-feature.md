---
description: Spec one feature into a PRD (swe-workflow step 3) — grill that feature with grill-with-docs, then synthesize its PRD with to-prd. Pass a feature slug from FEATURES.md. Runs per feature; to-issues slices the PRD afterward. Idempotent — skips a feature that already has a PRD.
